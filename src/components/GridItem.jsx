...
function GridItem(props) {
  return (
    <div
      ...
      className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div drop-shadow-glow"
    >
      {/* Hover Effects */}
      <div className="opacity-0 group-hover:opacity-100 text-center">
        ...
        <p className="text-1xl font-normal text-white">{props.descriptions}</p>
